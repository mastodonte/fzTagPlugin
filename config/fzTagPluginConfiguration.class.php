...
//            die();
  ...
  public function addFzTagAdminRoute(sfEvent $event) {
    $r = $event->getSubject();
    // preprend our route
    $r->prependRoute('fz_tag_admin', new sfDoctrineRouteCollection(array(
                'name' => 'fz_tag',
                'model' => 'fzTag',
                'module' => 'fzTagAdmin',
  ...
  public function addFzTagRoute(sfEvent $event) {
    $r = $event->getSubject();
    // preprend our route
    $r->prependRoute('fz_tag', new sfDoctrineRoute('/tags',
                    array(
                        'module' => 'fzTag',
                        'action' => 'index'
                    ),
    ...
    $r->prependRoute('fz_tag_show', new sfDoctrineRoute('/tags/:name',
                    array(
                        'module' => 'fzTag',
                        'action' => 'show'
                    ),
